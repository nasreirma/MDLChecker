...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\User\Desktop\Figma\build\assets\frame0")
    ...
    for i in range(1, total_rows):
        try:
            ...
            if y in File:
                ...
                # if self.sugg_check.isChecked():
                #     ws.Cells(i, 6).Value = get_close_matches(y, File, n=1)
        except:
            pass
